package com.guerniss.fragment.eye
...
//            param2 = it.getString(ARG_PARAM2)
    ...
    fun getProducts() {
        ...
        val call: Call<SingleCategoryProduct> = api.getEyeShadow()
        ...
        call.enqueue(object : Callback<SingleCategoryProduct?> {
            ...
            override fun onResponse(call: Call<SingleCategoryProduct?>, response: Response<SingleCategoryProduct?>) {
                ...
                if(result!=null){
                    ...
                    //Log.e("colorsiz",""+AppConstant.productListForColor.size)
