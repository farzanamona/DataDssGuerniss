...
class SerumAdapter (private val context : Context, private val serumProductlist: ArrayList<SerumModel>) : RecyclerView.Adapter<SerumAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val Movies = serumProductlist[position]
