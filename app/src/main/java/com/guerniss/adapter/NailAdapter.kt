...
class NailAdapter(private val context : Context, private val nailProductList: ArrayList<NailModel>) : RecyclerView.Adapter<NailAdapter.MyViewHolder>()  {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val Movies = nailProductList[position]
