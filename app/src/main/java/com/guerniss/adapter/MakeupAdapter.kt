...
class MakeupAdapter(private val context : Context, private val makeupProductList: ArrayList<MakeupModel>) : RecyclerView.Adapter<MakeupAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val Movies = makeupProductList[position]
