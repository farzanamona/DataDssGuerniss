...
class SkincareAdapter(private val context : Context, private val skincareProductlist: ArrayList<SkincareModel>) : RecyclerView.Adapter<SkincareAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val Movies = skincareProductlist[position]
    ...
    override fun getItemCount(): Int {
        return skincareProductlist.size
    }
}