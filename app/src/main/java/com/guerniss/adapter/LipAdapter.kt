...
class LipAdapter (private val context : Context, private val lipProductList: ArrayList<LipModel>) : RecyclerView.Adapter<LipAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val Movies = lipProductList[position]
