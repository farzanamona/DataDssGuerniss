...
class FaceAdapter (private val context : Context, private val faceProductList: ArrayList<FaceModel>) : RecyclerView.Adapter<FaceAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val Movies = faceProductList[position]
